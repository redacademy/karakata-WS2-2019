...
function red_starter_scripts() {
	...
	wp_enqueue_style( 'flickitycss', get_template_directory_uri() . '/sass/flickity.css' );
	...
	wp_enqueue_script( 'ajax', get_template_directory_uri() . '/build/js/ajax.min.js', array ( 'jquery' ), '', true);
